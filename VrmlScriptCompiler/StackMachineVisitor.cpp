...
namespace vrmlast
{
	...
	void StackMachineVisitor::visit(BinaryRelationalExpression *s) {
		
	}

	void StackMachineVisitor::visit(BinaryLogicalExpression *s) {}

	void StackMachineVisitor::visit(UnaryNotExpression *s) {}

	void StackMachineVisitor::visit(NullLiteralExpression *s) {}

	void StackMachineVisitor::visit(ReturnStatement *s) {}

	void StackMachineVisitor::visit(IfStatement *s) {}

	void StackMachineVisitor::visit(WhileStatement *s) {}

	void StackMachineVisitor::visit(NewExpression *s) {}

    void StackMachineVisitor::visit(CompoundAssignmentExpression *s)
    {
    }
}
