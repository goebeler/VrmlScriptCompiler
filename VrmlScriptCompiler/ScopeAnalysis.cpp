...
void vrmlast::ScopeAnalysis::visit(BinaryRelationalExpression *s) {}

void vrmlast::ScopeAnalysis::visit(BinaryLogicalExpression *s) {}

void vrmlast::ScopeAnalysis::visit(UnaryNotExpression *s) {}

void vrmlast::ScopeAnalysis::visit(NullLiteralExpression *s) {}

void vrmlast::ScopeAnalysis::visit(ReturnStatement *s) {}

void vrmlast::ScopeAnalysis::visit(IfStatement *s) {}

void vrmlast::ScopeAnalysis::visit(WhileStatement *s) {}

void vrmlast::ScopeAnalysis::visit(NewExpression *s) {}

void vrmlast::ScopeAnalysis::visit(CompoundAssignmentExpression *s)
{
}
